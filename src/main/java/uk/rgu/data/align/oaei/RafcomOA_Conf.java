...
//  static String vectorModelPath = "/program-data/DGXWord2Vec/data/model/wikipedia_plain_model300_min5_iter20_custom_token.txt";
  static String RESULT_DIR = "/results/oaei_conf_google/";
   ...
   *
   * @param t Selection threshold.
   * @param n Select best n if above t.
   */
...
//                line += "None" + ",";
              ...
              if (Evaluator.trueAlignment(groundTruth, alignedConcept)) { // check if present in the reference alignment
                ...
                if (typeId == 1) {
                  t1++;
                  System.out.println("T1: " + c1.getLabel() + " vs " + c2.getLabel() + " = " + c2.getScore());
                }
                if (typeId == 2) {
                  t2++;
                  System.out.println("T2: " + c1.getLabel() + " vs " + c2.getLabel() + " = " + c2.getScore());
                }
                if (typeId == 3) {
                  t3++;
                ...
                if (typeId == 4) {
                  t4++;
                  System.out.println("T4: " + c1.getLabel() + " vs " + c2.getLabel() + " = " + c2.getScore());
                }
              }
              line += classLabel;
              dataset.add(line);
...
//    String fileName = "results/alignment_features_oaei" + n + "_(exact_match).csv";
