...
/**
 * Baseline 2: Modification of Baseline 1 to remove parentheses, dashes and
 * underscores before lexical matching. Tries to improve StringEquiv.
 * Aligns concepts of ontologies only if any of the concept terms have exact
 * string match (case-insensitive).
 *
 * @author 1113938
 */
public class StringMatchingOA2 {
...
//    System.out.println("Concepts without vectors removed. " + scheme2 + " => " + concepts2.size());
    ...
    for (Concept c1 : concepts1) {
      ...
      for (Concept c2 : concepts2) {
        if (UseConceptVectors.checkStringMatch2(c1.getAllLabels(), c2.getAllLabels(), false)) {
